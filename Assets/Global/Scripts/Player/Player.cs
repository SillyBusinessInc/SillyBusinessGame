...
public class Player : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (healthBar) healthBar.UpdateHealthBar(playerStatistic.Health);
    }
    ...
    public void OnHit(float damage)
    {
        ...
        if (healthBar != null) healthBar.UpdateHealthBar(playerStatistic.Health);
    ...
    public void Heal(float reward)
    {
        ...
        healthBar.UpdateHealthBar(playerStatistic.Health);
    }
